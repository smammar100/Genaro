...
export function TableBody({
  ...
  return (
    <tbody
      className={cn(
        "relative in-data-[variant=card]:rounded-xl [&_tr:last-child]:border-0 in-data-[variant=card]:*:[tr]:border-0 in-data-[variant=card]:*:[tr]:*:[td]:border-b in-data-[variant=card]:*:[tr]:*:[td]:bg-card in-data-[variant=card]:*:[tr]:first:*:[td]:first:rounded-ss-xl in-data-[variant=card]:*:[tr]:*:[td]:first:border-s in-data-[variant=card]:*:[tr]:first:*:[td]:border-t in-data-[variant=card]:*:[tr]:last:*:[td]:last:rounded-ee-xl in-data-[variant=card]:*:[tr]:*:[td]:last:border-e in-data-[variant=card]:*:[tr]:first:*:[td]:last:rounded-se-xl in-data-[variant=card]:*:[tr]:last:*:[td]:first:rounded-es-xl in-data-[variant=card]:*:[tr]:hover:*:[td]:bg-(--bg-surface-hover) in-data-[variant=card]:*:[tr]:data-[state=selected]:*:[td]:bg-(--bg-surface-selected)",
        className,
      )}
...
export function TableRow({
  ...
  return (
    <tr
      className={cn(
        "relative border-b border-(--border-secondary) not-in-data-[variant=card]:hover:bg-(--bg-surface-hover) not-in-data-[variant=card]:data-[state=selected]:bg-(--bg-surface-selected)",
        className,
      )}
      data-slot="table-row"
      {...props}
